...
function refreshTableData(query) {
    ...
    var rows = document.getElementsByTagName("tr").length, msg = " entries";
    1 === rows && (msg = " entry"), $("#row-count").html(rows + msg), jQuery(document).ready(function($) {
        ...
        if (string += "<td class=" + column + ">", "collaboration_links" == column) {
            ...
            for (var i in collabs) {
                ...
                for (kv in collab_key) {
                    ...
                    k = k.trim(), name = name.trim(), string += '<a target="_top" href="http://www.sciencepolicyatlas.com/collaboration?collab=' + k + '">' + name + "</a>";
                    break;
                }
            }
