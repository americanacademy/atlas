...
function createTableBody(list) {
    ...
    msg += '<a target="_top" href="http://www.sciencepolicyatlas.com/">' + "tips" + "</a>";
    msg += " for leveraging the Atlas.";
    if(count === 1) {
        msg = " non-governmental organization, business, or university matches these search results. See" + '<a target="_top" href="http://www.sciencepolicyatlas.com/">' + "tips" + "</a>" + "for leveraging the Atlas.";
    }
