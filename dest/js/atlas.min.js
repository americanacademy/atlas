...
function createFilterFor(key) {
    ...
    if (key === 'organization_category') {
        // SOLELY FOR HIDING BUSINESS/BUSINESSES CATEGORIES UNTIL WE FIGURE OUT HOW TO UPDATE THE ORGANIZATION CATEGORY IN THE BACKEND
        for (var i = 0; i < options.length; i++) {
    	    if (options[i] != "Businesses" && options[i] != "Business" && options[i] != "Businesses & Private Sector") {
