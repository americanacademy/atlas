function dataLoaded() {
    loadFilters(), tableWithQuery(""), jQuery(document).ready(function($) {
        $("tr").click(function() {
...
function orgToRow(org) {
    for (var string = "<tr>", i = 0; i < tableCols.length; i++) col = tableCols[i], 
    string += "<td class=" + col + ">", string += org[col], string += "</td>\n";
    return string;
}
...
const table = $("#orgs"), tableCols = [ "organizations", "city", "participation" ];
