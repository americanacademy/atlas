            ...
            for (var i in filters) {
                ...
                if (!and_functionality) {
                    ...
                    if (filters[i] && filters[i].length > 0) {
                        ...
                        if (tableCols[i] == 'entity_category' && match.toLowerCase().includes('ngo')) {
                            var result = (filters[i].includes(row['entity_category_info'].trim()));
                        }
...
function createFilterFor(key, index) {
    ...
    if (key === 'collaboration_links') {
        ...
        for (var org in _data['entity']) {
            ...
            if (value.substr(0, 3) == 'NGO' && !value[6] == '5' && !value[6] == 'o') {
                value = '';
            }
