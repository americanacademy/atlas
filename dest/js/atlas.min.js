    ...
    if (filters) {
        for (var key in _data['entity']) {
            ...
            if (addToDisplay && row['entity_type'] == 'organization') {
                ...
                if (filteredRecords[key]['entity_category'].includes('501')) {
                    var old_entity_category = filteredRecords[key]['entity_category'];
                    filteredRecords[key]['entity_category'] = old_entity_category.substr(6, old_entity_category.length);
                }
            }
        }
    }
