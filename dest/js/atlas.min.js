                ...
                if (functionality == 'or') {
                    ...
                    if (filters[i] && filters[i].length > 0) {
                        ...
                        if (tableCols[i] == 'collaboration_links') {
                            ...
                            if (row[tableCols[i]].constructor === Array) {
                    ...
                    if (filters[i] && filters[i].length > 0) {
                        ...
                        if (tableCols[i] == 'collaboration_links') {
                            ...
                            if (row['entity_type'] == 'organization') {
                                var collab_result = false;
                                console.log(filters[i], filters);
                                if (collab_links_dict[key].includes(filters[i]) && (collab_links_dict[key].includes(filters[5]) || filters[5].length == 0)) {
                                    collab_result = true;
                                }
                            } else {
                                var collab_result = false;
...
function createFilterFor(key, index) {
    ...
    if (key === 'organization_category') {
        ...
        string += '<option disabled selected value> -- select a collaboration -- </option>';
    }
